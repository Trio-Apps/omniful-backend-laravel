...
return new class extends Migration
{
    ...
    {
        Schema::create('sap_item_groups', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('sap_sales_documents', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sap_sales_documents');
        Schema::dropIfExists('sap_item_groups');
    }
};
