<x-filament::page>
    <div wire:loading.flex wire:target="syncSuppliers" class="sap-sync-overlay">
        <div class="sap-sync-panel">
            <div class="sap-sync-spinner"></div>
            <div class="sap-sync-text">
                <div class="sap-sync-title">Syncing Suppliers from SAP</div>
                <div class="sap-sync-subtitle">Fetching Business Partners list...</div>
            </div>
    ...
    <div wire:loading.remove wire:target="syncSuppliers" class="sap-sync-complete">
