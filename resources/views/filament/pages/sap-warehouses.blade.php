<x-filament::page>
    ...
    <div wire:poll.5s class="sap-queue-card">
        <div class="sap-queue-header">
            <div>
                <div class="sap-queue-title">Background Warehouse Sync</div>
                <div class="sap-queue-subtitle">Queue warehouse sync from here. The page stays responsive while the worker processes the request.</div>
            </div>
        ...
        @if ($sync['has_event'])
            ...
            @endif
        @else
            <div class="sap-queue-empty">No background warehouse sync has been queued yet.</div>
        @endif
    ...
    <div wire:poll.5s class="sap-queue-card">
        <div class="sap-queue-header">
            ...
            <div class="sap-queue-actions">
                @if ($push['can_stop'])
                    <button type="button" class="sap-queue-stop" wire:click="cancelWarehousePush">
