<x-filament::page>
    <div wire:loading.flex wire:target="syncItems" class="sap-sync-overlay">
        <div class="sap-sync-panel">
            <div class="sap-sync-spinner"></div>
            <div class="sap-sync-text">
                <div class="sap-sync-title">Syncing Items from SAP</div>
                <div class="sap-sync-subtitle">Fetching item master list...</div>
            </div>
    ...
    <div wire:loading.remove wire:target="syncItems" class="sap-sync-complete">
