<x-filament::page>
    ...
    <div wire:loading.flex wire:target="pushItems" class="sap-sync-overlay">
        <div class="sap-sync-panel">
            <div class="sap-sync-spinner sap-sync-spinner--blue"></div>
            <div class="sap-sync-text">
                <div class="sap-sync-title">Pushing Items to Omniful</div>
    ...
    <div wire:loading.remove wire:target="pushItems" class="sap-sync-complete">
