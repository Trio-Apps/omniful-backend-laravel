...
class SapBanksCatalog extends Page implements HasTable
{
    ...
    protected static ?string $navigationLabel = 'SAP Banks';
    ...
    {
        return SapBank::query()->orderBy('code');
    }
    ...
    {
        return [
            ['label' => 'Banks', 'value' => SapBank::count(), 'hint' => 'Bank master rows'],
        ];
    }
