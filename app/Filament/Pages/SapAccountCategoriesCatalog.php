...
class SapAccountCategoriesCatalog extends Page implements HasTable
{
    ...
    protected static ?string $navigationLabel = 'SAP Account Categories';
    ...
    {
        return SapAccountCategory::query()->orderBy('code');
    }
    ...
    {
        return [
            ['label' => 'Categories', 'value' => SapAccountCategory::count(), 'hint' => 'Account category rows'],
        ];
    }
